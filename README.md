...
```
cd existing_repo
git remote add origin https://gitlab.gwdg.de/jeromario.schaefer/fairnessfrontend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.gwdg.de/jeromario.schaefer/fairnessfrontend/-/settings/integrations)
